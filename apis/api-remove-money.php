...
$transactionAmount = $_POST['moneyspent'];
$tNote = $_POST['transactionnote'];
$userId = $_POST['userid'];
...
$transaction = $db->prepare(" INSERT INTO transactions VALUES (null, :id, 1, :user, :amount, 0, :oldBalance, null) ");
